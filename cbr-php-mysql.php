                                ...
                                <br>
                                    ...
                                    <div id="perhitungan" style="display:none;">
                                        ...
                                        while ($datakasus = mysql_fetch_array($querykasus)) {
                                            ...
                                            echo "<td bgcolor=\"#FFFFFF\">" . $datakasus['no_kasus'] . "</td>";

                                            // lakukan pembobotan disini bukan menghitun gejala
                                            echo "<td bgcolor=\"#FFFFFF\">" . $jml_gejala_cocok . " gejala</td>";
                                            echo "<td bgcolor=\"#FFFFFF\">" . $totalhasil['total'] . "</td>";
                                            echo "<td bgcolor=\"#FFFFFF\">" . $jml_gejala_kasus . "</td>"; // hitung total bobot
                                            echo "<td bgcolor=\"#FFFFFF\">" . $jml_gejala_dipilih . "</td>";
                                            echo "<td bgcolor=\"#FFFFFF\">" . $pembagi . "</td>";
                                            echo "<td bgcolor=\"#FFFFFF\">" . $jml_gejala_cocok . " / " . $pembagi . " = " . $hasil . "</td>";
                                            echo "</tr>";
